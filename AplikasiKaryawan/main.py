...
gaji_emp_1 = Gaji('Rian','Hariadi','L','Manager',34,5,6500000)
gaji_emp_2 = Gaji('Budi','Santorso','L','Staff',31,3,3500000)

print('Gaji skr: ' ,gaji_emp_1.GajiBersih())
print(gaji_emp_2.GajiBersih())

print("Apabila Gaji dinaikkan .. (metode get) ")
print(gaji_emp_1.get_NaikGaji())
print('Gaji skr: ' , gaji_emp_1.GajiBersih())
...
print('Gaji skr:', gaji_emp_1.set_NaikGaji())
print('Gaji skr, setelah pajak:' ,gaji_emp_1.GajiBersih())
