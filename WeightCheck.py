'''Aplikasi sederhana untuk menentukan kondisi seseorang Gemuk, kurus atau ideal, berdasarkan medis.
 Dibuat oleh Rian Irawan Hariadi.. Aplikasi ini berguna untuk pemula Programmer Python 3.4 , 
 untuk bisa lebih memahami Struktur Class dalam OOP dan argument fungsi *args dan *kwargs '''
